...
#     v4.0 	Codename Wrasse /  2024 Build                                     #
######################################################################################

echo Mac Janitor by Darien Entwistle
echo   v4.0 	build CarsNCoffee 2024 Build
sleep 2s
...
if [ $major_version -gt 10 ] || [ $minor_version -ge 11 ]; then
    echo "Your Mac OS version is at least 10.11, App will continue";
else
...
# Clear Safari caches
echo ${YELLOW} Clearing Safari caches... ${STOPCOLOR}
rm -rf ~/Library/Caches/com.apple.Safari/*
rm -rf ~/Library/Caches/Metadata/Safari/*
echo ${GREEN} Safari caches cleared!! ${STOPCOLOR}

# Clear system caches
echo ${YELLOW} Clearing system caches... ${STOPCOLOR}
sudo rm -rf /Library/Caches/*
echo ${GREEN} System caches cleared!! ${STOPCOLOR}

# Clear user caches
echo ${YELLOW} Clearing user caches... ${STOPCOLOR}
rm -rf ~/Library/Caches/*
echo ${GREEN} User caches cleared!! ${STOPCOLOR}
